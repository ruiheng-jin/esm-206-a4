...
ggplot(lob_size, aes(x = size_mm)) +
  ...
  theme_light() +
    labs(x = "Lobster size (mm)", 
       ...
       caption = "Figure 2: This graph shows the size distributions of all the lobsters in 2012 and 2018 found in the five sites. one can see that for the site aqua, the sizes of the lobsters have increased. THey population for the IVEE site and the NAPL site drastically increased. ")
