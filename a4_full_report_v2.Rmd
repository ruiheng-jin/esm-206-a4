...
![Figure 1. California Spiny Lobster Credit: https://www.vice.com/en_us/article/gvk5kq/why-we-dont-eat-california-spiny-lobsters-even-though-they-taste-better](lob_ster.jpeg)
...
ggplot(lob_size, aes(x = size_mm)) +
  ...
  labs(x = "Lobster size (mm)", 
       ...
       caption = "Figure 3: This graph shows the density of sizes (mm) of all the lobsters in 2012 and 2018 found in the five sites.")
