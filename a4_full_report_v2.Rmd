...
- The 95% confidence interval is (`r mpa_12_18_ttest$conf.int`). 
- The effect size is large (Cohen's d = `r round(mpa_12_18_cohen$estimate, 3)`). 
- Mean lobster sizes at MPA sites in 2012 and 2018 are `r mpa_12_18_ttest$estimate`, respectively.
...
- The 95% confidence interval is (`r non_mpa_12_18_ttest$conf.int`). 
- The effect size is negligible (Cohen's d = `r round(nonmpa_12_18_cohen$estimate, 3)`). 
- Mean lobster sizes at non-MPA sites in 2012 and 2018 are `r non_mpa_12_18_ttest$estimate`, respectively.
...
- The 95% confidence interval is (`r lob_mpa_non_2012$conf.int`). 
- The effect size is medium (Cohen's d = `r round(mpa_non_12$estimate, 3)`). 
- In 2012, mean lobster sizes at MPA and non-MPA sites are `r lob_mpa_non_2012$estimate`, respectively.
...
mpa_non_18
```
- Mean lobster sizes differ significantly between MPA and non-MPA sites in 2012 (t(`r round(lob_mpa_non_2018$parameter, 2)`) = `r round(lob_mpa_non_2018$statistic, 2)`, p = `r round(lob_mpa_non_2018$p.value, 4)`). 
- The 95% confidence interval is (`r lob_mpa_non_2018$conf.int`). 
- The effect size is small (Cohen's d = `r round(mpa_non_18$estimate, 3)`). 
- In 2018, mean lobster sizes at MPA and non-MPA sites are `r lob_mpa_non_2018$estimate`, respectively.
