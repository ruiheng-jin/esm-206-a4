...
mpa_12_18_cohen
```
t(`r round(mpa_12_18_ttest$parameter, 2)`) = `r round(mpa_12_18_ttest$statistic, 2)`, p = `r round(mpa_12_18_ttest$p.value, 6)`

Cohen's d = `r round(mpa_12_18_cohen$estimate, 3)`
...
nonmpa_12_18_cohen
```
t(`r round(non_mpa_12_18_ttest$parameter, 2)`) = `r round(non_mpa_12_18_ttest$statistic, 2)`, p = `r round(non_mpa_12_18_ttest$p.value, 4)` 
Cohen's d = `r round(nonmpa_12_18_cohen$estimate, 3)`
...
mpa_non_12
```
t(`r round(lob_mpa_non_2012$parameter, 2)`) = `r round(lob_mpa_non_2012$statistic, 2)`, p = `r round(lob_mpa_non_2012$p.value, 4)` 
Cohen's d = `r round(mpa_non_12$estimate, 3)`
...
mpa_non_18
```
t(`r round(lob_mpa_non_2018$parameter, 2)`) = `r round(lob_mpa_non_2018$statistic, 2)`, p = `r round(lob_mpa_non_2018$p.value, 4)` 
Cohen's d = `r round(mpa_non_18$estimate, 3)`
